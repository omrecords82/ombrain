...
export const BLOCKERS: BlockerItem[] = [
  ...
  {
    id: 'bl-log-adapter',
    category: 'intentionally-disabled',
    name: 'Log adapter',
    impact: 'No automated log ingestion from the :7060→:3001 WS bridge (adapter disabled until bridge is stable)',
  ...
  },
  {
    ...
    requiredFix: 'Not required — intentional security boundary. LAN access via nginx (.254:8390 / :8392)',
