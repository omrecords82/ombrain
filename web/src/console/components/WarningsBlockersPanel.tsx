...
import { IconBan, IconClipboardX, IconSettingsExclamation } from '@tabler/icons-react';
...
export default function WarningsBlockersPanel() {
  ...
  return (
    <ConsolePanel title="Warnings & Blocked Capabilities" description="Known platform gaps — static facts, not live probes">
      <Box>
        {BLOCKERS.map((b) => {
            ...
            >
              ...
              <Box sx={{ flex: 1, minWidth: 0 }}>
                <Stack direction="row" spacing={1} alignItems="center" flexWrap="wrap" useFlexGap>
                  ...
                  <Chip size="small" variant="outlined" label={CATEGORY_LABEL[b.category]} />
